...
def plot_uncertainty_over_time(uncertainty_history, save_path='uncertainty_over_timesteps.png', title_suffix=''):
    '''
    Plot uncertainty metrics over diffusion timesteps.
    ...
    # Plot 1: Mean uncertainties
    ax1 = axes[0]
    ax1.plot(timesteps, uncertainty_history['mean_total'], 
             label='Total Uncertainty', linewidth=2, marker='o', markersize=4, alpha=0.7)
    ax1.plot(timesteps, uncertainty_history['mean_epistemic'], 
             label='Epistemic Uncertainty', linewidth=2, marker='s', markersize=4, alpha=0.7)
    ax1.plot(timesteps, uncertainty_history['mean_aleatoric'], 
             label='Aleatoric Uncertainty', linewidth=2, marker='^', markersize=4, alpha=0.7)
    
    ax1.set_xlabel('Diffusion Timestep (t)', fontsize=12)
    ax1.set_ylabel('Mean Uncertainty (Entropy)', fontsize=12)
    title = 'Mean Uncertainty Over Diffusion Timesteps\n(Averaged over all masked token positions)'
    if title_suffix:
        title += f'\n{title_suffix}'
    ...
    ax2 = axes[1]
    ax2.plot(timesteps, uncertainty_history['std_epistemic'], 
             label='Epistemic Std', linewidth=2, marker='s', markersize=4, alpha=0.7)
    ax2.plot(timesteps, uncertainty_history['std_aleatoric'], 
             label='Aleatoric Std', linewidth=2, marker='^', markersize=4, alpha=0.7)
    ax2.plot(timesteps, uncertainty_history['std_total'], 
             label='Total Std', linewidth=2, marker='o', markersize=4, alpha=0.7)
    
    ax2.set_xlabel('Diffusion Timestep (t)', fontsize=12)
    ax2.set_ylabel('Standard Deviation', fontsize=12)
    ax2.set_title('Uncertainty Standard Deviation Over Diffusion Timesteps\n(Variability across masked positions)', 

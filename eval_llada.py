...
class LLaDAEvalHarness(LM):
    def __init__(
        ...
        **kwargs,
        ...
        # Strip quotes that may be included from command-line parsing
        self.remasking = remasking.strip().strip("'\"") if isinstance(remasking, str) else remasking
    ...
    def generate_until(self, requests: list[Instance]):
        ...
        for elem in tqdm(ds, desc="Generating..."):
            ...
            generated_answer = generate(self.model, prompt, steps=self.steps, gen_length=self.gen_length, block_length=self.block_length,
                                        ...
                                        mc_samples=self.mc_samples, alpha=self.alpha, beta=self.beta, dropout_p=self.dropout_p)
